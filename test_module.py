...
test_cases = [
    ...
    pytest.param(
        ...
        'Expected calling "arithmetic_arranger()" with more than five problems to return +\
        "Error: Too many problems."',
    ...
    pytest.param(
        ...
        'Expected calling "arithmetic_arranger()" with a problem that contains a +\
        letter character in the number to return +\
        "Error: Numbers must only contain digits."',
        id='test_only_digits'),
    pytest.param(
        [['3 + 855', '988 + 40'], True],
        ...
        "arithmetic_arranger()" with ["3 + 855", "988 + 40"] +\
    ...
    pytest.param(
        ...
        'Expected solutions to be correctly displayed in output when calling +\
        "arithmetic_arranger()" +\
        with five arithmetic problems and a second argument of `True`.',
